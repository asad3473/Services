    ...
    <section className='py-16 lg:px-10  font-ui-sans-serif'>
      <div className='container mx-auto px-4'>
        <div className='text-center mb-12'>
          <h6 className='text-lg '>TechSoft So Different?</h6>
        ...
        <div className='flex flex-wrap -mx-4 ' data-aos='fade-right'>
          {whyChooseData.map((item, index) => (
            <div key={index} className='w-full  lg:w-1/3 md:w-1/2 px-4 mb-8'>
              <div className=' p-6 h-full border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border-[#008bd0]'>
                <div className='mb-4'>
                  <img
                    src={item.icon}
                    alt='svg icon'
                ...
                <h3 className='text-2xl font-semibold mb-4 text-center text-[#008bd0]'>
                  {item.title}
                </h3>
