      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='flex flex-wrap -mx-4' data-aos='fade-right'>
          {workSteps.map((step) => (
            ...
            >
              <div className=' p-6 rounded-lg border border-[#008bd0] shadow-lg relative'>
                <div
                  className={`flex items-center justify-center w-12 h-12 text-white border  rounded-full absolute -top-6 left-1/2 transform -translate-x-1/2  ${step.color}`}
                >
                  <span className='text-xl font-bold '>{step.number}</span>
                </div>
                <div className='mt-12'>
                  <h3 className='text-xl font-semibold text-[#008bd0]'>
                    {step.title}
                  </h3>
